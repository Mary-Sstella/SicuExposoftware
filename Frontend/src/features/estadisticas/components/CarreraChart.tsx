...
function CarreraChart({ data }: Props) {
    ...
    return (
        <div className="bg-white dark:bg-gray-900 rounded-2xl p-4 md:p-6 shadow-md border border-gray-200 dark:border-gray-800">
            <div className="flex items-start justify-between mb-5">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h2 className="text-sm font-bold text-gray-800 dark:text-gray-200">Estudiantes por Carrera</h2>
                        <p className="text-xs text-gray-400">Distribución total de estudiantes inscritos</p>
                    </div>
                </div>
                <div className="flex items-center gap-1.5 px-3 py-1.5 bg-gray-50 dark:bg-gray-800 rounded-xl border border-gray-100 dark:border-gray-700">
                ...
                {visible.map((d) => {
                    ...
                    return (
                        <div key={d.carrera} className="flex items-center gap-3">
                            <span className="text-xs text-gray-500 dark:text-gray-400 w-20 md:w-32 shrink-0 truncate text-right">{d.carrera}</span>
                            ...
                            <span className="text-xs font-semibold text-gray-500 dark:text-gray-400 w-5 text-right shrink-0">{d.total}</span>
                        </div>
                    )
                })}
            </div>
